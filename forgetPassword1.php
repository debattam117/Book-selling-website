      ...
      <div class="col-2">
         <div class="form-container">    
               ...
               <form id="PasswordForm" action="" method="POST">
                   <input type="number" name ="code1" placeholder="Enter the code" required>
				   <input type="password" name="newPassword3" placeholder="New Password" required>
                   <button type="submit" name="submit5" class="btn">Submit</button>
				   <a>
<?php			

$sess=$_SESSION['user'][0];
$emp=$_SESSION['user'][1];
...
if(isset($_POST['submit5']))
 { 
   $code=$_POST['code1'];
   $npwd=$_POST['newPassword3'];

    if($sess==$code)
	{
		$query="update user set password='$npwd', confirm_password='$npwd' where email='$emp'";
