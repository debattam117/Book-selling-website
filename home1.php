...
<div class="header">
  ...
  <span class="ms" style="font-family:'popins', sans-serif;color:white;">Login First : To Contact Us</span>
         ...
         <div class="row1">
            <div class="col-1">
             ...
             <div class="col-2">
              ...
              <ul>
               <li><a href="login.php">Sign in</a></li><span class="crimson-text">&nbsp;&nbsp;&#124;</span>
             ...
             <div class="row sliders">
                ...
                <div class="col-6"><img src="poster2.jpg" style=" width: 1800px; height: 700px; cursor: pointer;">
                  <div class="write">
                    ...
                    <p style="font-size: 25px; margin-right: 230px; animation: slide 1.5s ease-in;">Starting At Rs.99</p>
				 ...
				 <div class="col-6"><img src="poster6.jpg" style=" width: 2300px; height: 700px; cursor: pointer;">
                  <div class="write1">
                    ...
                    <h1 style="font-family: 'Playfair Display', serif; font-size: 60px; margin-left: -93px; line-height: 10px; margin-bottom: 60px; margin-top: 30px; color:white ;"> Story Books</h1>
                ...
                <div class="col-6"><img src="poster5.jpg" style=" width: 1600px; height: 500px; cursor: pointer;">
                  <div class="write2">
                    ...
                    <p style="font-size: 30px; margin-left:80px ;color:white ;">Exclusive Offers -10% Off This Week</p>
                    <h1 style="font-family: 'Playfair Display', serif; font-size: 60px; margin-left: -90px; line-height: 10px; margin-bottom: 60px; margin-top: 30px; color:white ;"> Story Books</h1>
                    <p style="font-size: 25px; margin-right: 200px; color:white ;">Starting At Rs.299</p>
                    <a href=""class="btn" style="text-decoration: none; margin-top: 50px; margin-right: 255px;">Check out &#x2794;</a>
	       ...
	       <div class="col-41">
				    <div class="fixedImage1">
                        <div class="product-name1">
						 <a  href="ParticularBookPage.php?value=<?php echo $result1['bookname'];?>"> 
...
<div class="footer">
  <div class="main-foot">
    ...
    <hr>
			 <h5 class="copyright">&#169;Copyright 2022 - APNA MARKET </h5>
...
$(document).ready(function() {
    $(document).on('submit', '#sbs', function() {
      // do your things
      return false;
     });
});
