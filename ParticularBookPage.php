...
<div class="alert hide">
  ...
  <span class="ms" style="font-family:'popins', sans-serif;color:white;">Login First : To Add Comments</span>
...
<div class="comment">
           ...
           <h2> REVIEW <?php echo"$sesse";  ?> </h2>
		    <form id="comments" action="" method="POST" name="cm" >
				  <textarea rows="5"  name="commen" placeholder="WRITE HERE" maxlength="400" ></textarea>
				       <div class="btnn">
				         
						  <input type="submit" name="submit1" value='Submit' id='sb'>
...
$(document).ready(function() {
    $(document).on('submit', '#comments', function() {
      // do your things
      return false;
     });
});
